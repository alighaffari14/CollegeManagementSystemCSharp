    ...
    public partial class frmFeePaymentRecord1 : Form
    {
        ...
        private void AutocompleteCourse()
        {
            ...
            try
            {
                ...
                adp.SelectCommand = new SqlCommand("SELECT distinct RTRIM(Course) FROM FeePayment", CN);
                ds = new DataSet("ds");
        ...
        private void Course_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string ct = "select distinct RTRIM(branch) from FeePayment where course= '" + Course.Text + "'";
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(StudentName)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Semester],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from FeePayment where ScholarNo= '" + ScholarNo.Text + "' order by DateOfPayment", con);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID], RTRIM(StudentName)[Student Name],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Semester],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from FeePayment where DateOfPayment between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by DateOfPayment", con);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTRIM(ScholarNo)[Scholar No.], RTRIM(StudentName)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Semester],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from FeePayment where DateOfPayment between @date1 and @date2 order by DateOfPayment ", con);
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTRIM(ScholarNo)[Scholar No.], RTRIM(StudentName)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Semester],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from FeePayment where DateOfPayment between @date1 and @date2 and DueFees > 0 order by DateOfPayment ", con);
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                cmd = new SqlCommand("select RTrim(FeePaymentID)[Fee Payment ID],RTRIM(ScholarNo)[Scholar No.], RTRIM(StudentName)[Student Name],RTRIM(Course)[Course],RTRIM(Branch)[Branch],RTRIM(FeeID)[Fee ID],RTRIM(Semester)[Semester],RTRIM(DateOfPayment)[Payment Date],RTRIM(ModeOfPayment)[Mode Of Payment],RTRIM(PaymentModeDetails)[Payment Mode Details],RTRIM(TotalPaid)[Total Paid],RTRIM(Fine)[Fine],RTRIM(DueFees)[Due Fees]  from FeePayment where DateOfPayment between @date1 and @date2 and Fine > 0 order by DateOfPayment ", con);

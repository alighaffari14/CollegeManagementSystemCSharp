    ...
    public partial class frmFeesPaymentReport : Form
    {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MyCommand.CommandText = "select *  from FeePayment where DateOfPayment between @date1 and @date2 order by DateOfPayment";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from FeePayment where DateOfPayment between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by DateOfPayment";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from FeePayment where ScholarNo= '" + ScholarNo.Text + "'order by DateOfPayment";
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from FeePayment where DateOfPayment between @date1 and @date2 and DueFees > 0 order by DateOfPayment";

    ...
    public partial class frmSalaryPayment : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string cb = "insert into EmployeePayment(PaymentId,StaffId,staffname,basicsalary,PaymentDate,ModeOfPayment,PaymentModeDetails,Deduction,TotalPaid) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9)";
                ...
                cmd.Parameters.Add(new SqlParameter("@d3", System.Data.SqlDbType.NChar, 30, "StaffName"));
        ...
        private void btnUpdate_record_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update EmployeePayment set StaffId=@d2,staffname=@d3,basicsalary=@d4,PaymentDate=@d5,ModeOfPayment=@d6,PaymentModeDetails=@d7,Deduction=@d8,TotalPaid=@d9 where PaymentID=@d1";

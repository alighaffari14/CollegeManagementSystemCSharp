    ...
    public partial class frmUserRegistration : Form
    {
        ...
        private void Register_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@d7", System.Data.SqlDbType.NChar, 15, "usertype"));
        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string cb = "update user_registration set password=@d2,contact_no=@d3,email=@d4,name=@d5,date_of_joining=@d6,usertype=@d7 where username=@d1";

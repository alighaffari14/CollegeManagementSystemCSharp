    ...
    public partial class frmScholarshipPaymentReport : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MyCommand.CommandText = "select *  from ScholarshipPayment where PaymentDate between @date1 and @date2 and Course= '" + Course.Text + "'and branch='" + Branch.Text + "' order by PaymentDate ";
        ...
        private void ScholarNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from ScholarshipPayment where ScholarNo='" + ScholarNo.Text + "' order by PaymentDate";
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from ScholarshipPayment order by PaymentDate ";
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select *  from ScholarshipPayment where PaymentDate between @date1 and @date2 and  DuePayment > 0 order by PaymentDate ";

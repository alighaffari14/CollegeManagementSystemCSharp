    ...
    public partial class frmStudentsRegistrationReport : Form
    {
        ...
        private void StudentName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from studentRegistration where Student_name='" + StudentName.Text + "' order by DateOfAdmission";
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                myConnection = new SqlConnection("Data Source=GHAFFARI\\ALIGHAFFARI;Initial Catalog=CMS;Integrated Security=True;");
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "select * from studentRegistration where Student_name like '" + StudentName.Text + "%' order by DateOfAdmission";

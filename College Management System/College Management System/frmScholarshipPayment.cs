        ...
        private void Update_record_Click(object sender, EventArgs e)
        {
            ...
            try{
             con = new SqlConnection(cs);
                ...
                string cb = "update scholarshippayment set Scholarshipid=@d2,Scholarshipname=@d3,amount=@d5,ScholarNo=@d6,StudentName=@d7,Course=@d8,Branch=@d9,PaymentDate=@d10,PaymentMode=@d11,PaymentModeDetails=@d12,TotalPaid=@d13,DuePayment=@d14 where scholarshippaymentid=@d1";     
                cmd = new SqlCommand(cb);
